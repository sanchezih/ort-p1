package ar.edu.ort.p1.u2.polimorfismoConInterfaces.src;


import java.util.ArrayList;

import ar.edu.ort.p1.u2.polimorfismoConInterfaces.src.seleccion.Entrenador;
import ar.edu.ort.p1.u2.polimorfismoConInterfaces.src.seleccion.Futbolista;
import ar.edu.ort.p1.u2.polimorfismoConInterfaces.src.seleccion.Masajista;
import ar.edu.ort.p1.u2.polimorfismoConInterfaces.src.seleccion.SeleccionFutbol;
