package ar.edu.ort.p1.u2.herenciaSeleccionEsp.src;

import java.util.ArrayList;

import ar.edu.ort.p1.u2.herenciaSeleccionEsp.src.seleccion.Entrenador;
import ar.edu.ort.p1.u2.herenciaSeleccionEsp.src.seleccion.Futbolista;
import ar.edu.ort.p1.u2.herenciaSeleccionEsp.src.seleccion.IntegranteDeSeleccion;
import ar.edu.ort.p1.u2.herenciaSeleccionEsp.src.seleccion.Masajista;
