package ar.edu.ort.p1.u2.interfacesEjemploFigura.src;

import java.util.ArrayList;
import java.util.List;

import ar.edu.ort.p1.u2.interfacesEjemploFigura.src.figuras.Circulo;
import ar.edu.ort.p1.u2.interfacesEjemploFigura.src.figuras.Cuadrado;
import ar.edu.ort.p1.u2.interfacesEjemploFigura.src.figuras.Figura;
import ar.edu.ort.p1.u2.interfacesEjemploFigura.src.figuras.Rectangulo;
