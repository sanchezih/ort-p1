package edu.ort.p1.u2.polimorfismo.src;

import java.util.ArrayList;

import edu.ort.p1.u2.polimorfismo.src.polimorfismo.Entrenador;
import edu.ort.p1.u2.polimorfismo.src.polimorfismo.Futbolista;
import edu.ort.p1.u2.polimorfismo.src.polimorfismo.IntegranteDeSeleccion;
import edu.ort.p1.u2.polimorfismo.src.polimorfismo.Masajista;
