package ar.edu.ort.p1.u2.polimorfismo.src;

import java.util.ArrayList;

import ar.edu.ort.p1.u2.polimorfismo.src.polimorfismo.Entrenador;
import ar.edu.ort.p1.u2.polimorfismo.src.polimorfismo.Futbolista;
import ar.edu.ort.p1.u2.polimorfismo.src.polimorfismo.IntegranteDeSeleccion;
import ar.edu.ort.p1.u2.polimorfismo.src.polimorfismo.Masajista;
