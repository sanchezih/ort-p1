...
public interface Facturable {
	 ...
	 * decir, campos de clase, publicos y constantes. No hace falta incluir las
	 * palabras public static final porque todos los campos seran tratados como si
	 * llevaran estas palabras. Recordemos que static equivalia a "de clase" y final
	 * a "constante".
	 */
