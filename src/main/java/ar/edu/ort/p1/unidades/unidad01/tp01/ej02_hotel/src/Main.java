package ar.edu.ort.p1.unidades.unidad01.tp01.ej02_hotel.src;

import java.util.ArrayList;

import com.github.sanchezih.util.ds.UtilArraylist;
...
public class Main {
	...
	public static void main(String[] args) {
		...
		UtilArraylist.listarElementos((ArrayList<Habitacion>) hotel.obtenerHabitacionesDisponibles());
