...
import ar.edu.ort.p1.unidades.unidad05.practico05.ej07_academia_cursos.src.listasordenadas.ListaDeAlumnosPorEdad;
...
public class Curso {
	...
	private ListaOrdenada<Integer, Alumno> listaDeAlumnosPorEdad = new ListaDeAlumnosPorEdad();
	...
	public void agregarAlumno(Alumno alumno) {
		this.listaDeAlumnosPorEdad.add(alumno);
	}
