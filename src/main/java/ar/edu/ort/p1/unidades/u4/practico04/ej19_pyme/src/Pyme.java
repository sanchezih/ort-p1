...
public class Pyme {
	...
	/**
	 * Ejercicio 19-B: La explotacion del metodo altaDeEmpleado que recibe los datos de
	...
	/**
	 * Ejercicio 19-C: La explotacion del metodo bajaDeEmpleado que recibe el DNI de un
