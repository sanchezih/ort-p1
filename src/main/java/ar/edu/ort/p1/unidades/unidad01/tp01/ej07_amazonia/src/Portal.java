...
public class Portal {
	...
	public List<Producto> procesarPedido(Cliente cliente) {
		...
		List<Producto> listaDeProductosFaltantes = new ArrayList<>();
		Pedido pedidoPendiente = cliente.getPedidoPendiente(); // Se obtiene el pedido pendiente

		if (pedidoPendiente != null && !pedidoPendiente.hayStockSuficiente()) {
			listaDeProductosFaltantes = pedidoPendiente.getListaDeProductosFaltantes();
		}
		return listaDeProductosFaltantes;
	}
