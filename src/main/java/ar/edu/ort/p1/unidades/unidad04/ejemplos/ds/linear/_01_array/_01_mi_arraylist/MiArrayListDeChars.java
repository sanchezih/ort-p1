package ar.edu.ort.p1.unidades.unidad04.ejemplos.ds.linear._01_array._01_mi_arraylist;
...
public class MiArrayListDeChars {
	...
	public void add(char elemento) {
		...
		int longitud = this.elementos.length;
		char[] vectorNuevo = new char[longitud + 1];
