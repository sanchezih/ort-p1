package ar.edu.ort.p1.unidades.unidad01.tp01.ej04_droides.src;
...
public class Droide {
	...
	static int cantFS = 0;
	private String id;
	private List<Pieza> piezasOperativas;
	...
	/**
	 * La explotacion del metodo autoRepararse de la clase Droide, que no recibe
	 * parametros. Debe intentar reemplazar sus piezas no operativas por las piezas
	 * operativas que pudiera encontrar en alguno de los otros droides. Cada vez que
	 * una pieza se reemplaza la pieza no operativa original se descarta.
	 * 
	 * Este metodo devuelve alguno de estos resultados:
	 * 
