...
public class Main {
	public static void main(String[] args) {
		...
		Producto dune = new Producto("Dune", 159.00, 8); // Agrego 8 Dune al stock
		Producto romeoYJulieta = new Producto("Romeo y Julieta", 189.00, 1); // Agrego 1 Romeo y Julieta al stock
