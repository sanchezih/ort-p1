...
public class Comision {
	...
	public void mostrarAlumnosAptosParaFinal() {
		...
		for (int i = 0; i < this.alumnos.length; i++) {
			...
			double cantFaltas = getCantFaltasDeAlumno(asistenciaDeAlumno);
			double porcPresentismo = 100 - ((cantFaltas * 100) / this.cantClases);
	...
	public double[] getPorcDePresentismoPorClase() {
		...
		for (int i = 0; i < this.cantClases; i++) {
			int presentes = getCantPresentesEnClase(i);
			double porcPresentismo = ((presentes * 100) / this.cantAlumnos);
