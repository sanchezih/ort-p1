...
public class Main {
	...
	public static void main(String[] args) {
		...
		while (!sorteadorDeStrings.isEmpty()) {
			System.out.println("\t -> Saco un elemento: " + sorteadorDeStrings.remove()); // toUpperCase() no podria ser
																							// sin castear a String
		}
		...
		while (!sorteadorDeIntegers.isEmpty()) {
			System.out.println("\t -> Saco un elemento: " + sorteadorDeIntegers.remove()); // toUpperCase() no podria
																							// ser sin castear a String
		}
