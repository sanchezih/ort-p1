package ar.edu.ort.p1.unidades.unidad05.practico05.ej06_edificio_inteligente.src;
...
public class Main {
	...
	public static void main(String[] args) {
		...
		// Creo facturas sin ningun orden en particular y las pusheo en la pila

		Pila<Factura> pilaDeFacturas = new PilaNodos<>();
