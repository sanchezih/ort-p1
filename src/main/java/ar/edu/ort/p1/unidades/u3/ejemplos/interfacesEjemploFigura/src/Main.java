package ar.edu.ort.p1.unidades.u3.ejemplos.interfacesEjemploFigura.src;

import java.util.ArrayList;
import java.util.List;

import ar.edu.ort.p1.unidades.u3.ejemplos.interfacesEjemploFigura.src.figuras.Circulo;
import ar.edu.ort.p1.unidades.u3.ejemplos.interfacesEjemploFigura.src.figuras.Cuadrado;
