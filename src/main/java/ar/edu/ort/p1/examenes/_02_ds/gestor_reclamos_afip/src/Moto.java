...
public class Moto extends Vehiculo {
	...
	private static final double COEFICIENTE_IMPONIBLE_CALLE = 100;
	private static final double COEFICIENTE_IMPONIBLE_DEPORTIVA = 150;
	private static final double COEFICIENTE_IMPONIBLE_CHOPERA = 200;
