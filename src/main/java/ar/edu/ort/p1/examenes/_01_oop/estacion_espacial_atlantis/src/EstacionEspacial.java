...
public class EstacionEspacial {
	...
	private static final int CANT_ATRAQUES = 10; // Este valor es arbitrario
	private List<PuntoDeAtraque> atraques;
	...
	public boolean estacionarNave(Nave nave) {
		...
		System.out.println("Se intenta estacion la nave: ");
		nave.imprimirManifiesto();
		...
		System.out.println("Se pudo estacionar? -> " + sePudo);
		System.out.println();
		return sePudo;
	}
