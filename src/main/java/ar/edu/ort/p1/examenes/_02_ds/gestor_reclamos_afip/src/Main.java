...
public class Main {
	...
	public static void main(String[] args) {
		...
		c2.agregarBien(new Moto("kawasaki", "Z400", 400, TipoDeMoto.DEPORTIVA)); // Paga 190
		...
		Ciudadano c4 = new Ciudadano(44444444, "Fernanda", "Quiroga");
		...
		// Creo los ciudadanos
		System.out.println("Agrego los ciudadanos a la lista...");
		...
		// Creo los reclamos
		System.out.println();
		System.out.println("Agrego los reclamos a la pila...");
		...
		Cola<Reclamo> colaDeReclamos = gestorAfip.evaluarReclamos();
		...
		UtilCola.mostrarColaGenerica(colaDeReclamos);
	}
}
