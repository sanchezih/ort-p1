...
public class Teatro {
	...
	public void ingreso(List<Espectador> espectadores) {
		...
		System.out.println("Comienza el ingreso...");
		...
		for (Espectador espectador : espectadores) {
			...
			if (obra != null && obra.puedeIngresar(espectador)) {
				...
				System.out.println("\tEl espectador con DNI " + espectador.getDni() + " SI puede ingresar");
			} else {
				System.out.println("\tEl espectador con DNI " + espectador.getDni() + " NO puede ingresar");
			}
		}
	}
	...
	public void otorgarPremio(int cantEntradas) {
		...
		System.out.println("Comienza la entrega de premios...");
