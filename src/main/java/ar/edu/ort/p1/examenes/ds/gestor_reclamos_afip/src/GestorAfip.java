...
public class GestorAfip {
	...
	private ListaOrdenadaDniDesc ciudadanos;
	private PilaDeReclamos reclamos;

	/*----------------------------------------------------------------------------*/

	public GestorAfip() {
		this.ciudadanos = new ListaOrdenadaDniDesc();
	...
	public void agregarCiudadano(Ciudadano ciudadano) {
		...
		System.out.println(
				"\t-> " + ciudadano.toString() + " deberia pagar un total de $" + ciudadano.determinarImpuesto());
	}
	...
	public void mostrarCiudadanos() {
		System.out.println("Mustro a los ciudadanos...");
