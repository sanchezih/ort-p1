...
public class Main {
	...
	public static void main(String[] args) {
		...
		instituto.mostrarColaDeEmpleados();

		// Test ejercicio B
		ListaDeEmpleadosPorDniAsc listaDeEmpleadosEnFalta = instituto.empleadosEnFalta();

		System.out.println();

		System.out.println("Lista de empleados con irregularidades, ordenados por DNI (ASC):");
		for (Empleado empleado : listaDeEmpleadosEnFalta) {
