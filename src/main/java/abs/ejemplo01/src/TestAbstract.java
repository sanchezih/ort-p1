...
public class TestAbstract {
	public static void main(String[] Args) {
		...
		ProfesorInterino pi1 = new ProfesorInterino("Maria", "Hernandez Lopez", 45, "45221887-K", fecha1);
		ProfesorInterino pi2 = new ProfesorInterino("Andres", "Molto Parra", 87, "72332634-L", fecha1);
		ProfesorInterino pi3 = new ProfesorInterino("Rosa", "Rios Mesa", 76, "34998128-M", fecha1);

		ProfesorTitular pt1 = new ProfesorTitular("Adriana", "Perez Perez", 23, "73-K");
