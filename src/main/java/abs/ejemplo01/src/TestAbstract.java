...
public class TestAbstract {
	public static void main(String[] Args) {
		...
		ProfesorInterino pi1 = new ProfesorInterino("Maria", "Hernandez", 45, "45221887-K", fecha1);
		ProfesorInterino pi2 = new ProfesorInterino("Andres", "Molto", 87, "72332634-L", fecha1);
		ProfesorInterino pi3 = new ProfesorInterino("Rosa", "Rios", 76, "34998128-M", fecha1);

		ProfesorTitular pt1 = new ProfesorTitular("Adriana", "Perez", 23, "73-K");
		ProfesorTitular pt2 = new ProfesorTitular("Alberto", "Centa", 49, "88-L");
		ProfesorTitular pt3 = new ProfesorTitular("Alberto", "Centa", 49, "81-F");
