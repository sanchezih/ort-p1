package edu.ort.herenciaSeleccionEsp.src;

import java.util.ArrayList;

import edu.ort.herenciaSeleccionEsp.src.seleccion.Entrenador;
import edu.ort.herenciaSeleccionEsp.src.seleccion.Futbolista;
import edu.ort.herenciaSeleccionEsp.src.seleccion.IntegranteDeSeleccion;
import edu.ort.herenciaSeleccionEsp.src.seleccion.Masajista;
