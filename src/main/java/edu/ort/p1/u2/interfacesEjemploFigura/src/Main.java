package edu.ort.p1.u2.interfacesEjemploFigura.src;

import java.util.ArrayList;
import java.util.List;

import edu.ort.p1.u2.interfacesEjemploFigura.src.figuras.Circulo;
import edu.ort.p1.u2.interfacesEjemploFigura.src.figuras.Cuadrado;
import edu.ort.p1.u2.interfacesEjemploFigura.src.figuras.Figura;
import edu.ort.p1.u2.interfacesEjemploFigura.src.figuras.Rectangulo;
