package edu.ort.p1.u2.herenciaSeleccionEsp.src;

import java.util.ArrayList;

import edu.ort.p1.u2.herenciaSeleccionEsp.src.seleccion.Entrenador;
import edu.ort.p1.u2.herenciaSeleccionEsp.src.seleccion.Futbolista;
import edu.ort.p1.u2.herenciaSeleccionEsp.src.seleccion.IntegranteDeSeleccion;
import edu.ort.p1.u2.herenciaSeleccionEsp.src.seleccion.Masajista;
