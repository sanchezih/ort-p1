package edu.ort.p1.u2.polimorfismoConInterfaces.src;


import java.util.ArrayList;

import edu.ort.p1.u2.polimorfismoConInterfaces.src.seleccion.Entrenador;
import edu.ort.p1.u2.polimorfismoConInterfaces.src.seleccion.Futbolista;
import edu.ort.p1.u2.polimorfismoConInterfaces.src.seleccion.Masajista;
import edu.ort.p1.u2.polimorfismoConInterfaces.src.seleccion.SeleccionFutbol;
