package edu.ort.p1.u3.practico03.tp3_cabinas_peaje.src;

import java.util.ArrayList;

import edu.ort.p1.u3.practico03.tp3_cabinas_peaje.src.mediosdepago.Efectivo;
import edu.ort.p1.u3.practico03.tp3_cabinas_peaje.src.mediosdepago.MedioDePago;
import edu.ort.p1.u3.practico03.tp3_cabinas_peaje.src.mediosdepago.PASE;
import edu.ort.p1.u3.practico03.tp3_cabinas_peaje.src.mediosdepago.SUBE;
...
public class Main {
	...
	public static void main(String[] args) {
		...
		// Ejercicio D
		System.out.println(
				"\nEl promedio de dias de demora entre todas las cabinas que acepten medios de pago electr�nicos (SUBE o PASE) es "
						+ ep1.promedioDemora());
	}
}