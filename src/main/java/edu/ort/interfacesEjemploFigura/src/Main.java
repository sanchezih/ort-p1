package edu.ort.interfacesEjemploFigura.src;

import java.util.ArrayList;
import java.util.List;

import edu.ort.interfacesEjemploFigura.src.figuras.Circulo;
import edu.ort.interfacesEjemploFigura.src.figuras.Cuadrado;
import edu.ort.interfacesEjemploFigura.src.figuras.Figura;
import edu.ort.interfacesEjemploFigura.src.figuras.Rectangulo;
