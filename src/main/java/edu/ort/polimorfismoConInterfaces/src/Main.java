package edu.ort.polimorfismoConInterfaces.src;


import java.util.ArrayList;

import edu.ort.polimorfismoConInterfaces.src.seleccion.Entrenador;
import edu.ort.polimorfismoConInterfaces.src.seleccion.Futbolista;
import edu.ort.polimorfismoConInterfaces.src.seleccion.Masajista;
import edu.ort.polimorfismoConInterfaces.src.seleccion.SeleccionFutbol;
